...
// Generar círculos dentro de los límites
let randomRadius = Math.floor(Math.random() * 100 + 30); // Radio aleatorio entre 30 y 130

// Asegurarse de que los círculos estén dentro de los límites de canvasRandom
...
// Generar múltiples círculos dentro de los límites de canvasMultiple
let arrayCircle = [];

for (let i = 0; i < 10; i++) {
  let randomRadius = Math.floor(Math.random() * 10 + 20); // Radio aleatorio entre 20 y 30

  // Asegurarse de que los círculos estén dentro de los límites de canvasMultiple
